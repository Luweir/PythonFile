...
def decode_exactly(geohash, lat_min, lat_max, lon_min, lon_max):
    """
    ...
    lat_err, lon_err = (lat_interval[1] - lat_interval[0]) / 2, (lon_interval[1] - lon_interval[0]) / 2
    is_even = True
    for c in geohash:
        cd = __decodemap[c]
...
def decode(geohash, lat_min, lat_max, lon_min, lon_max):
    """
    Decode geohash, returning two strings with latitude and longitude
    containing only relevant digits and with trailing zeroes removed.
    """
    lat, lon, lat_err, lon_err = decode_exactly(geohash, lat_min, lat_max, lon_min, lon_max, )
...
def encode(latitude, longitude, lat_min, lat_max, lon_min, lon_max, precision=12):
    """
